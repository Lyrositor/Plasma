...
{
    DebugMsg(plFormat("Message {} was rejected, reason:{}, age:{}, client:{}", 
...
void plNetMsgScreener::IRejectLogMsg(const plMessage* msg, const char* desc, const plNetGameMember* gm) const
{
    ...
    DebugMsg(plFormat("Message {} was rejected, reason:{}, age:{}, client:{}, msgSndr:{}, msgRcvr:{}", 
        msg->ClassName(), desc, IGetAgeName(), IGetSenderName(gm), senderName, rcvrName));
}
